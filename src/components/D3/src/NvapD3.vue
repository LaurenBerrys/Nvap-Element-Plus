 ...
 * @LastEditTime: 2023-11-24 10:07:39
 * @Description: 
-->
<template>
  <el-space v-loading="loading" v-if="loading" w-full h-full items-center />
...
<script setup lang="ts">
  ...
  import { canvasDrawNode, canvasDrawLink } from './hooks/canvasModel';
